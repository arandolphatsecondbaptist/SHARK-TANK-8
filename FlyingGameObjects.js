...
obst = new Circle(10);
obst.setPosition(620, Randomizer.nextInt(0, getHeight() + 90));
obst.setColor(Color.white);
obst2 = new Circle(10);
obst2.setPosition(580, Randomizer.nextInt(0, getHeight() + 90));
...
function moveCharacter() {
    ...
    if(lost == true){
       ...
       txt.setPosition(getWidth()/3, getHeight()/2);
